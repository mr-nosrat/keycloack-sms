...
public enum ErrorCodes {
    ...
    SERVICE_TYPE_NOT_FOUND(20, "check the service type you're requesting. we don't get what service you want to use. your sender number might be wrong, too."),
    ...
    public static String getDescriptionForCode(int code) {
        switch (code) {
            ...
            case 1:
                return INVALID_RECIPIENT_NUMBER.description;
            case 2:
                return INVALID_SENDER_NUMBER.description;
            case 3:
                return INVALID_ENCODING.description;
            case 4:
                return INVALID_MESSAGE_CLASS.description;
            case 6:
                return INVALID_UDH.description;
            case 12:
                return INVALID_ACCOUNT_ID.description;
            case 13:
                return NULL_MESSAGE.description;
            case 14:
                return CREDIT_NOT_ENOUGH.description;
            case 15:
                return SERVER_ERROR.description;
            case 16:
                return ACCOUNT_INACTIVE.description;
            case 17:
                return ACCOUNT_EXPIRED.description;
            case 18:
                return INVALID_USERNAME_PASSWORD_DOMAIN.description;
            case 19:
                return AUTHENTICATION_FAILED.description;
            case 20:
                return SERVICE_TYPE_NOT_FOUND.description;
            case 22:
                return ACCOUNT_SERVICE_NOT_FOUND.description;
            case 23:
                return SERVER_BUSY.description;
            case 24:
                return INVALID_MESSAGE_ID.description;
            case 106:
                return WEB_RECIPIENT_NUMBER_ARRAY_IS_NULL.description;
            case 107:
                return WEB_RECIPIENT_NUMBER_ARRAY_TOO_LONG.description;
            case 108:
                return WEB_SENDER_NUMBER_ARRAY_IS_NULL.description;
            case 103:
                return WEB_RECIPIENT_NUMBER_ARRAY_SIZE_NOT_EQUAL_SENDER_NUMBER_ARRAY.description;
            case 101:
                return WEB_RECIPIENT_NUMBER_ARRAY_SIZE_NOT_EQUAL_MESSAGE_ARRAY.description;
            case 104:
                return WEB_RECIPIENT_NUMBER_ARRAY_SIZE_NOT_EQUAL_UDH_ARRAY.description;
            case 102:
                return WEB_RECIPIENT_NUMBER_ARRAY_SIZE_NOT_EQUAL_MESSAGE_CLASS_ARRAY.description;
            case 109:
                return WEB_RECIPIENT_NUMBER_ARRAY_SIZE_NOT_EQUAL_ENCODING_ARRAY.description;
            case 110:
                return WEB_RECIPIENT_NUMBER_ARRAY_SIZE_NOT_EQUAL_CHECKING_MESSAGE_IDS__ARRAY.description;
            default:
                return "";
        }
    }

    public static int MAX_VALUE = 110;
}
